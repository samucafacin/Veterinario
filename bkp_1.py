...
import pgto  # Importa o módulo de pagamento
...
class App:
    ...
    def _montar_pagamentos(self):
        ...
        ttk.Label(frm, text="Valor:").grid(row=0, column=4, padx=5, pady=5)
        ...
        self.tree_pagamentos = ttk.Treeview(self.frame_pagamentos, columns=("Cliente", "Serviço", "Valor", "Forma"), show="headings", height=12)
